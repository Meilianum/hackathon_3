...
const CartPage = () => {
  ...
  const handleRemove = (id: string) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        removeFromCart(id); // Removes from local storage
        setCartItems(getCartItems()); // Refresh cart state
        Swal.fire(
          "Removed!",
  ...
  const handleQuantityChange = (id: string, quantity: number) => {
    updateCartQuantity(id, quantity); // Updates quantity in local storage
    setCartItems(getCartItems()); // Refresh cart state
  };
